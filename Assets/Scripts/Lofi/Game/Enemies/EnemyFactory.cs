...
namespace Lofi.Game
{
    public class EnemyFactory : MonoBehaviour
    {
        ...
        static EnemyFactory()
        {
            ...
            //BOSS
            AddEnemy("Boss1", "Sprites/Enemies/Boss1", 2, 1, "Dungeon");
            AddEnemy("Boss2", "Sprites/Enemies/Boss2", 2, 1, "Dungeon");
            AddEnemy("Boss3", "Sprites/Enemies/Boss3", 2, 1, "Dungeon");
            AddEnemy("Boss4", "Sprites/Enemies/Boss4", 2, 1, "Dungeon");
            AddEnemy("Boss5", "Sprites/Enemies/Boss5", 2, 1, "Dungeon");
            AddEnemy("BossFinal", "Sprites/Enemies/BossFinal", 2, 1, "Dungeon");

            //DESERT
            AddEnemy("DarkWizard", "Sprites/Enemies/DarkWizard", 2, 1, "Desert", new RangedAttackBehavior());
            ...
            AddEnemy("GuardianSeer", "Sprites/Enemies/GuardianSeer", 2, 1, "Forest", new RangedAttackBehavior());
            ...
            AddEnemy("Spider", "Sprites/Enemies/Spider", 2, 1, "ALL");
        ...
        private static void AddEnemy(string name, string sprite, int health, int damage, string habitat = "ALL", IEnemyBehavior behavior = null)
        {
        ...
        private static GameObject SpawnEnemy(GameObject parent, EnemyTemplate template)
        {
            ...
            if (template.Behavior != null)
            {
                enemy.enemyBehavior = template.Behavior;
